...
(defsystem protobuf-example
  ...
  :components ((:static-file "Makefile")
               ...
               ;; component type PROTOBUF-SOURCE-FILE causes the proto file to be converted into
               ;; Lisp code, which is then compiled and/or loaded.
               (:protobuf-source-file "addressbook")
               (:cl-source-file "package" :depends-on ("addressbook"))
